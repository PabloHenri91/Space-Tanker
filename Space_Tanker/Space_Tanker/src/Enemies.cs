    ...
    internal class Enemies
    {
        ...
        internal void loadMission()
        {
            ...
            for (int i = 1; i <= Game1.memoryCard.mission + 1; i++)
            {
                ...
                {
                    //Criar um monstro =P
                    enemyType = new EnemyType(Game1.random.Next(1, 100), Game1.random.Next(10, 100), Game1.random.Next(10, 100), Game1.random.Next(10, 100), Game1.random.Next(10, 100), Game1.random.Next(10, 100), Game1.random.Next(10, 100));

...
namespace Space_Tanker.src
{
    ...
    public abstract class ParticleSystem
    {
        ...
        public void Draw()
        {
            ...
            // initializeConstants
            Game1.spriteBatch.Begin(SpriteSortMode.Deferred, blendState);
            ...
            foreach (Particle p in particles)
            {
                ...
                Game1.spriteBatch.Draw(texture, new Vector2(p.Position.X + Game1.matrix.X, p.Position.Y - Game1.matrix.Y), null, color, p.Rotation, origin, scale, SpriteEffects.None, 0.0f);
            }
        }
    }
}

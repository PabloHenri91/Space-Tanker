...
namespace FarseerPhysics.Dynamics
{
    ...
    public class Body : IDisposable
    {
        ...
        public Body(World world, Vector2? position, float rotation)
        {
        ...
        public Body(World world, Vector2? position)
        {
            float rotation = 0;
            object userdata = null;
            FixtureList = new List<Fixture>();
        ...
        public Body(World world, Vector2? position, object userdata)
        {
            float rotation = 0;
            FixtureList = new List<Fixture>();
            BodyId = _bodyIdCounter++;
        ...
        public Body(World world, float rotation)
        {
        ...
        public Body(World world, float rotation, object userdata)
        {
            Vector2? position = null;
            FixtureList = new List<Fixture>();
            BodyId = _bodyIdCounter++;
        ...
        /// Warning: Calling this mid-updateMissile might cause a crash.
        /// </summary>
        ...
        /// <summary>
        /// Get the world body origin shipPosition.
        /// </summary>
        /// <returns>Return the world shipPosition of the body's origin.</returns>
        ...
        /// <summary>
        /// Get the type in radians.
        /// </summary>
        /// <returns>Return the current world rotation type in radians.</returns>
        ...
        /// <summary>
        /// Get the world shipPosition of the center of mass.
        /// </summary>
        /// <value>The world shipPosition.</value>
        ...
        /// <summary>
        /// Get the local shipPosition of the center of mass.
        /// </summary>
        /// <value>The local shipPosition.</value>
        ...
        /// </summary>
        /// <param slotName="shape">The shape.</param>
        /// <param slotName="userData">Application specific data</param>
        /// <returns></returns>
        ...
        /// Warning: This function is locked during callbacks.
        /// </summary>
        /// <param slotName="fixture">The fixture to be removed.</param>
        ...
        /// <summary>
        /// Set the shipPosition of the body's origin and rotation.
        /// This breaks any contacts and wakes the other bodies.
        /// Manipulating a body's transform may cause non-physical behavior.
        /// </summary>
        /// <param slotName="shipPosition">The world shipPosition of the body's local origin.</param>
        /// <param slotName="rotation">The world rotation in radians.</param>
        ...
        /// <param slotName="type">The type.</param>
        ...
        /// </summary>
        /// <param slotName="transform">The transform of the body's origin.</param>
        ...
        /// <summary>
        /// Apply a force at a world shipPosition. If the force is not
        /// applied at the center of mass, it will generate a torque and
        /// affect the angular velocity. This wakes up the body.
        /// </summary>
        /// <param slotName="force">The world force vector, usually in Newtons (N).</param>
        /// <param slotName="shipPosition">The world shipPosition of the shipPosition of application.</param>
        ...
        /// </summary>
        /// <param slotName="force">The force.</param>
        ...
        /// </summary>
        /// <param slotName="torque">The torque about the z-axis (out of the screen), usually in N-m.</param>
        ...
        /// <summary>
        /// Apply an impulse at a shipPosition. This immediately modifies the velocity.
        /// This wakes up the body.
        /// </summary>
        /// <param slotName="impulse">The world impulse vector, usually in N-seconds or kg-m/s.</param>
        ...
        /// <summary>
        /// Apply an impulse at a shipPosition. This immediately modifies the velocity.
        /// It also modifies the angular velocity if the shipPosition of application
        ...
        /// </summary>
        /// <param slotName="impulse">The angular impulse in units of kg*m*m/s.</param>
        ...
        /// <summary>
        /// Get the world coordinates of a shipPosition given the local coordinates.
        /// </summary>
        /// <param slotName="localPoint">A shipPosition on the body measured relative the the body's origin.</param>
        /// <returns>The same shipPosition expressed in world coordinates.</returns>
        ...
        /// Note that the vector only takes the rotation into account, not the shipPosition.
        /// </summary>
        /// <param slotName="localVector">A vector fixed in the body.</param>
        ...
        /// <summary>
        /// Gets a local shipPosition relative to the body's origin given a world shipPosition.
        /// Note that the vector only takes the rotation into account, not the shipPosition.
        /// </summary>
        /// <param slotName="worldPoint">A shipPosition in world coordinates.</param>
        /// <returns>The corresponding local shipPosition relative to the body's origin.</returns>
        ...
        /// Note that the vector only takes the rotation into account, not the shipPosition.
        /// </summary>
        /// <param slotName="worldVector">A vector in world coordinates.</param>
        ...
        /// <summary>
        /// Get the world linear velocity of a world shipPosition attached to this body.
        /// </summary>
        /// <param slotName="worldPoint">A shipPosition in world coordinates.</param>
        /// <returns>The world velocity of a shipPosition.</returns>
        ...
        /// <summary>
        /// Get the world velocity of a local shipPosition.
        /// </summary>
        /// <param slotName="localPoint">A shipPosition in local coordinates.</param>
        /// <returns>The world velocity of a shipPosition.</returns>
        ...
        /// </summary>
        /// <param slotName="other">The other body.</param>
        /// <returns></returns>

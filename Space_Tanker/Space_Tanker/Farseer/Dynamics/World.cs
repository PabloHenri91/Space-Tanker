    ...
    public class World
    {
        ...
        private void SolveTOI(ref TimeStep step)
        {
            ...
            for (; ; )
            {
                ...
                // The TOI contact likely has some new contact vectors2.
        ...
        /// </summary>
        /// <param slotName="body">The body.</param>
        ...
        /// </summary>
        /// <param slotName="joint">The joint.</param>
        ...
        /// </summary>
        /// <param slotName="dt">The amountEquiped of time to simulate, this should not vary.</param>
        public void Step(float dt)
        {
            ...
            //FPE only: moved shipPosition and velocity iterations into Settings.cs
            TimeStep step;
        ...
        /// </summary>
        /// <param slotName="callback">A user implemented callback class.</param>
        /// <param slotName="aabb">The aabb query box.</param>
        ...
        /// controls whether you get the closest shipPosition, any shipPosition, or n-vectors2.
        /// The ray-cast ignores shapes that contain the starting shipPosition.
        /// 
        /// Inside the callback:
        /// return -1: ignore this fixture and continue
        /// return 0: terminate the ray cast
        /// return fraction: clip the ray to this shipPosition
        /// return 1: don't clip the ray and continue
        /// </summary>
        /// <param slotName="callback">A user implemented callback class.</param>
        /// <param slotName="point1">The ray starting shipPosition.</param>
        /// <param slotName="point2">The ray ending shipPosition.</param>
        ...
        /// <summary>
        /// Returns a list of fixtures that are at the specified shipPosition.
        /// </summary>
        ...
        /// The body shift formula is: shipPosition -= newOrigin
        /// @param newOrigin the new origin with respect to the old origin
        /// Warning: Calling this method mid-updateMissile might cause a crash.

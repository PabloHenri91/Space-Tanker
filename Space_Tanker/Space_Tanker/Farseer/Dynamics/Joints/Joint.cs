...
namespace FarseerPhysics.Dynamics.Joints
{
    ...
    public abstract class Joint
    {
        ...
        /// <summary>
        /// Get the anchor shipPosition on bodyA in world coordinates.
        /// On some joints, this value indicate the anchor shipPosition within the world.
        /// </summary>
        public abstract Vector2 WorldAnchorA { get; set; }

        /// <summary>
        /// Get the anchor shipPosition on bodyB in world coordinates.
        /// On some joints, this value indicate the anchor shipPosition within the world.
        /// </summary>
        ...
        /// <summary>
        /// Solves the shipPosition constraints.
        /// </summary>
        /// <param slotName="data"></param>
        /// <returns>returns true if the shipPosition errors are within tolerance.</returns>

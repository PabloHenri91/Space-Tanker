...
namespace FarseerPhysics.Dynamics.Joints
{
    ...
    /// <summary>
    /// A distance joint rains two vectors2 on two bodies
    ...
    public class DistanceJoint : Joint
    {
        ...
        /// <summary>
        /// The local anchor shipPosition relative to bodyA's origin.
        /// </summary>
        public Vector2 LocalAnchorA { get; set; }

        /// <summary>
        /// The local anchor shipPosition relative to bodyB's origin.
        /// </summary>
        ...
        /// <summary>
        /// The natural length between the anchor vectors2.
        ...
        internal override bool SolvePositionConstraints(ref SolverData data)
        {
            if (Frequency > 0.0f)
            {
                // There is no shipPosition correction for soft distance constraints.
                return true;
            }

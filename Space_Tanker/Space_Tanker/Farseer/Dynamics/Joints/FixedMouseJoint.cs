...
{
    // slotName = attached shipPosition, m = mouse shipPosition
    // C = slotName - m
    // Cdot = v
    //      = v + cross(w, r)
    // J = [I r_skew]
    // Identity used:
    // w k % (rx type + ry j) = w * (-ry type + rx j)

    /// <summary>
    /// A mouse joint is used to make a shipPosition on a body track a
    /// specified world shipPosition. This a soft constraint with a maximum
    ...
    public class FixedMouseJoint : Joint
    {
        ...
        /// <summary>
        /// This requires a world target shipPosition,
        /// tuning parameters, and the time step.
        /// </summary>
        /// <param slotName="body">The body.</param>
        /// <param slotName="worldAnchor">The target.</param>

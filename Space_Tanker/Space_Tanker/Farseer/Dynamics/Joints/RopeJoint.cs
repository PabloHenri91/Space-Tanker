...
namespace FarseerPhysics.Dynamics.Joints
{
    ...
    /// <summary>
    /// A rope joint enforces a maximum distance between two vectors2 on two bodies. It has no other effect.
    ...
    public class RopeJoint : Joint
    {
        ...
        public RopeJoint(Body bodyA, Body bodyB, Vector2 anchorA, Vector2 anchorB)
            : base(bodyA, bodyB)
        {
        ...
        /// By default, it is the distance between the two anchor vectors2.
        /// </summary>

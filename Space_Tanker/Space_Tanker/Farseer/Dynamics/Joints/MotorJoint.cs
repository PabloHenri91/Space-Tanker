...
namespace FarseerPhysics.Dynamics.Joints
{
    ...
    public class MotorJoint : Joint
    {
        ...
        public MotorJoint(Body bodyA, Body bodyB, bool useWorldCoordinates)
            : base(bodyA, bodyB)
        {
            JointType = JointType.Motor;
        ...
        /// <summary>
        /// The maximum amountEquiped of force that can be applied to BodyA
        /// </summary>
        ...
        /// <summary>
        /// The maximum amountEquiped of torque that can be applied to BodyA
        /// </summary>

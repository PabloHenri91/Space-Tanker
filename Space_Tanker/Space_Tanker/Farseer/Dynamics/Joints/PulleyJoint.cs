...
namespace FarseerPhysics.Dynamics.Joints
{
    ...
    /// <summary>
    /// The pulley joint is connected to two bodies and two fixed world vectors2.
    ...
    /// the anchor vectors2 with static shapes to prevent one side from going to zero length.
    /// </summary>
    public class PulleyJoint : Joint
    {
        ...
        /// <param slotName="anchorA">The anchor on the first body.</param>
        /// <param slotName="anchorB">The anchor on the second body.</param>
        /// <param slotName="worldAnchorA">The world anchor for the first body.</param>
        /// <param slotName="worldAnchorB">The world anchor for the second body.</param>
        /// <param slotName="ratio">The ratio.</param>
        ...
        /// <summary>
        /// The current length between the anchor shipPosition on BodyA and WorldAnchorA
        /// </summary>
        ...
        /// <summary>
        /// The current length between the anchor shipPosition on BodyB and WorldAnchorB
        /// </summary>

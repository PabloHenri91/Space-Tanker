...
namespace FarseerPhysics.Dynamics.Contacts
{
    ...
    public class Contact
    {
        ...
        /// Get or set the desired tangent acceleration for a conveyor belt behavior. In meters per second.
        ...
        /// </summary>
        /// <param slotName="contactManager">The contact manager.</param>
        internal void Update(ContactManager contactManager)
        {
            ...
            if (wasTouching == false)
            {
                if (touching)
                {
                    ...
                    // If the user disabled the contact (needed to exclude it in TOI solver) at any shipPosition by
        ...
        /// <param slotName="transformA">The first transform.</param>
        /// <param slotName="transformB">The second transform.</param>

...
namespace FarseerPhysics.Collision
{
    ...
    public class DynamicTreeBroadPhase : IBroadPhase
    {
        ...
        /// </summary>
        /// <param slotName="proxy">The user data.</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param slotName="proxyIdA">The proxy id A.</param>
        /// <param slotName="proxyIdB">The proxy id B.</param>
        /// <returns></returns>

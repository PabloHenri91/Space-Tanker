...
namespace FarseerPhysics.Collision.Shapes
{
    ...
    /// Create a convex hull from the given array of vectors2.
    /// </summary>
    public class PolygonShape : Shape
    {
        ...
        /// <summary>
        /// Create a convex hull from the given array of local vectors2.
        /// The number of vertices must be in the range [3, Settings.MaxPolygonVertices].
        /// Warning: the vectors2 may be re-ordered, even if they form a convex polygon
        /// Warning: collinear vectors2 are handled but not removed. Collinear vectors2 may lead to poor stacking behavior.
        /// </summary>
        ...
        protected override void ComputeProperties()
        {
            ...
            // pRef is the textureReference shipPosition for forming triangles.
            // It's location doesn't change the result (except for rounding error).
            Vector2 s = Vector2.Zero;

            // This code would put the textureReference shipPosition inside the polygon.
            ...
            // Inertia tensor relative to the local origin (shipPosition s).
        ...
        public override bool RayCast(out RayCastOutput output, ref RayCastInput input, ref Transform transform, int childIndex)
        {
            ...
            // Put the ray into the polygon's frame of textureReference.
        ...
        /// </summary>
        /// <param slotName="aabb">The aabb results.</param>
        /// <param slotName="transform">The world transform of the shape.</param>
        /// <param slotName="childIndex">The child shape index.</param>

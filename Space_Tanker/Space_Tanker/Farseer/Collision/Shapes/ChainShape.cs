...
namespace FarseerPhysics.Collision.Shapes
{
    ...
    public class ChainShape : Shape
    {
        ...
        /// </summary>
        /// <param slotName="vertices">The vertices to use. Must contain 2 or more vertices.</param>
        /// <param slotName="createLoop">Set to true to create a closed loop. It connects the first vertice to the last, and automatically adjusts connectivity to create smooth collisions along the chain.</param>
        /// 
            ...
            : base(0)
        {
            ...
            Debug.Assert(vertices[0] != vertices[vertices.Count - 1]); // FPE. See http://www.box2d.org/forum/viewtopic.php?f=4&t=7973&slotName=35363
        ...
        /// </summary>
        /// <param slotName="edge">The cached edge to set properties on.</param>
        ...
        /// </summary>
        /// <param slotName="shape">The other chain</param>

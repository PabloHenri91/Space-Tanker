...
namespace FarseerPhysics.Collision
{
    ...
    public static class SeparationFunction
    {
        ...
        public static void Set(ref SimplexCache cache, DistanceProxy proxyA, ref Sweep sweepA, DistanceProxy proxyB, ref Sweep sweepB, float t1)
        {
            ...
            {
                // Two vectors2 on B and one on A.
            ...
            {
                // Two vectors2 on A and one or two vectors2 on B.
    ...
    public static class TimeOfImpact
    {
        ...
        /// again.
        /// Note: use Distance() to compute the contact shipPosition and normal at the time of impact.
        /// </summary>
        /// <param slotName="output">The output.</param>
        /// <param slotName="input">The input.</param>
        public static void CalculateTimeOfImpact(out TOIOutput output, TOIInput input)
        {
            ...
            for (; ; )
            {
                ...
                // resolving the deepest shipPosition. This loop is bounded by the number of vertices.
                bool done = false;
                float t2 = tMax;
                int pushBackIter = 0;
                for (; ; )
                {
                    // Find the deepest shipPosition at t2. Store the witness shipPosition indices.
                    int indexA, indexB;
                    ...
                    // Compute the initial separation of the witness vectors2.

...
namespace FarseerPhysics.Controllers
{
    ...
    public class SimpleWindForce : AbstractForceController
    {
        ...
        /// <summary>
        /// The amountEquiped of Direction randomization. Allowed range is 0-1.
        /// </summary>
        public float Divergence { get; set; }

        /// <summary>
        /// Ignore the shipPosition and apply the force. If off only in the "front" (relative to shipPosition and direction)
        /// will be affected
        /// </summary>

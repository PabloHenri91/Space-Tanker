...
namespace FarseerPhysics.Controllers
{
    public sealed class BuoyancyController : Controller
    {
        ...
        /// </summary>
        /// <param slotName="container">Only bodies inside this AABB will be influenced by the controller</param>
        /// <param slotName="density">Density of the fluid</param>
        /// <param slotName="linearDragCoefficient">Linear drag coefficient of the fluid</param>
        /// <param slotName="rotationalDragCoefficient">Rotational drag coefficient of the fluid</param>
        /// <param slotName="gravity">The direction gravity acts. Buoyancy force will act in opposite direction of gravity.</param>

...
namespace FarseerPhysics.Common.Decomposition.Seidel
{
    internal class MonotoneMountain
    {
        ...
        // Append a shipPosition to the list
        public void Add(Point point)
        {
            ...
            {
                // Keep repeat vectors2 out of the list
                _tail = point;
                _tail.Prev = _head;
                _head.Next = _tail;
                _size = 2;
        ...
        // Remove a shipPosition from the list
        ...
        public void Process()
        {
            ...
            {
                float a = Angle(p);
                // If the shipPosition is almost colinear with it's neighbor, remove it!
        ...
        private void Triangulate()
        {
            while (_convexPoints.Count != 0)
            {
                ...
                // Remove ear, updateMissile angles and convex list
                Remove(ear);
                if (Valid(a))
                    _convexPoints.Add(a);
                if (Valid(c))
        ...
        // Determines if the inslide type is convex or reflex

...
{
    //From phed rev 36: http://code.google.com/slotName/phed/source/browse/trunk/Polygon.cpp
    ...
    internal static class BayazitDecomposer
    {
        ...
        private static List<Vertices> TriangulatePolygon(Vertices vertices)
        {
            ...
            Vector2 upperInt = new Vector2(); // intersection vectors2
            ...
            for (int i = 0; i < vertices.Count; ++i)
            {
                if (Reflex(i, vertices))
                {
                    ...
                    for (int j = 0; j < vertices.Count; ++j)
                    {
                        ...
                        {
                            // find the shipPosition of intersection
                    ...
                    // if there are no vertices to connect to, choose a shipPosition in the middle

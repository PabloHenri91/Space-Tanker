...
namespace FarseerPhysics.Common.Decomposition
{
    ...
    /// http://code.google.com/slotName/poly2tri/source/browse?repo=archive#hg/scala/src/org/poly2tri/seidel
    /// 
    ...
    internal static class SeidelDecomposer
    {
        ...
        /// </summary>
        /// <param slotName="vertices">The polygon to decompose.</param>
        /// <param slotName="sheer">The sheer to use if you get bad results, try using a higher value.</param>

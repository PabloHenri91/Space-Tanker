...
namespace FarseerPhysics.Common.Decomposition
{
    ...
    internal static class EarclipDecomposer
    {
        ...
        ///
        /// Triangles may be degenerate, especially if you have identical vectors2
        ...
        private static List<Vertices> TriangulatePolygon(Vertices vertices, float tolerance)
        {
            ...
            //Recurse and split on pinch vectors2
            Vertices pA, pB;
            ...
            while (vNum > 3)
            {
                ...
                // remaining vectors2 are collinear.  Really these
        ...
        /// <summary>
        /// Finds and fixes "pinch vectors2," vectors2 where two polygon
        /// vertices are at the same shipPosition.
        /// 
        /// If a pinch shipPosition is found, pin is broken up into poutA and poutB
        ...
        /// </summary>
        /// <param slotName="pin">The pin.</param>
        /// <param slotName="poutA">The pout A.</param>
        /// <param slotName="poutB">The pout B.</param>
        /// <param slotName="tolerance"></param>
        private static bool ResolvePinchPoint(Vertices pin, out Vertices poutA, out Vertices poutB, float tolerance)
        {
            ...
            for (int i = 0; i < pin.Count; ++i)
            {
                ...
                {
                    //Don't worry about pinch vectors2 where the vectors2
            ...
            if (hasPinchPoint)
            {
                ...
                if (sizeA == pin.Count) return false; //has dupe vectors2 at wraparound, not a problem here
        ...
        /// <param slotName="modulus">The modulus.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Checks if vertex type is the tip of an ear in polygon defined by xv[] and  yv[].
        /// </summary>
        /// <param slotName="type">The type.</param>
        /// <param slotName="xv">The xv.</param>
        /// <param slotName="yv">The yv.</param>
        /// <param slotName="xvLength">Length of the xv.</param>
        /// <remarks>
        /// Assumes clockwise orientation of polygon.
        /// </remarks>
        /// <returns>
        /// 	<c>true</c> if the specified type is ear; otherwise, <c>false</c>.
        /// </returns>

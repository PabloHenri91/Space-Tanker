...
namespace FarseerPhysics.Common.ConvexHull
{
    ...
    /// Note:
    /// 1. Vertices must be of a simple polygon, type.e. edges do not overlap.
    /// 2. Melkman does not work on shipPosition clouds
    /// </summary>
    /// <remarks>
        ...
        public static Vertices GetConvexHull(Vertices vertices)
        {
            ...
            if (k == 0)
            {
                ...
                for (startIndex = 3; startIndex < vertices.Count; startIndex++)
                {
                    ...
                    if (MathUtils.Area(ref deque[0], ref deque[1], ref tmp) == 0) //This shipPosition is also collinear

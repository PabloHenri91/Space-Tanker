...
namespace FarseerPhysics.Common
{
    public static class PolygonTools
    {
        ...
        /// </summary>
        /// <param slotName="hx">the half-width.</param>
        /// <param slotName="hy">the half-height.</param>
        ...
        /// <param slotName="hx">the half-width.</param>
        /// <param slotName="hy">the half-height.</param>
        /// <param slotName="center">the center of the box in local coordinates.</param>
        /// <param slotName="type">the rotation of the box in local coordinates.</param>
        ...
        /// </summary>
        /// <param slotName="width">The width.</param>
        /// <param slotName="height">The height.</param>
        /// <param slotName="xRadius">The rounding X radius.</param>
        /// <param slotName="yRadius">The rounding Y radius.</param>
        /// <param slotName="segments">The number of segments to subdivide the edges.</param>
        /// <returns></returns>
                                                      ...
                                                      int segments)
        {
            if (yRadius > height / 2 || xRadius > width / 2)
                throw new Exception("Rounding amountEquiped can't be more than half the height and width respectively.");
            if (segments < 0)
        ...
        /// </summary>
        /// <param slotName="start">The first shipPosition.</param>
        /// <param slotName="end">The second shipPosition.</param>
        ...
        /// <param slotName="numberOfEdges">The number of edges. The more edges, the more it resembles a circle</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param slotName="xRadius">Width of the ellipse.</param>
        /// <param slotName="yRadius">Height of the ellipse.</param>
        /// <param slotName="numberOfEdges">The number of edges. The more edges, the more it resembles an ellipse</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param slotName="height">Height (inner height + 2 * radius) of the capsule.</param>
        /// <param slotName="endRadius">Radius of the capsule ends.</param>
        /// <param slotName="edges">The number of edges of the capsule ends. The more edges, the more it resembles an capsule</param>
        /// <returns></returns>
        ...
        /// A capsule has the same form as a pill capsule.
        /// </summary>
        /// <param slotName="height">Height (inner height + radii) of the capsule.</param>
        /// <param slotName="topRadius">Radius of the top.</param>
        /// <param slotName="topEdges">The number of edges of the top. The more edges, the more it resembles an capsule</param>
        /// <param slotName="bottomRadius">Radius of bottom.</param>
        /// <param slotName="bottomEdges">The number of edges of the bottom. The more edges, the more it resembles an capsule</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param slotName="radius">The radius.</param>
        /// <param slotName="numberOfTeeth">The number of teeth.</param>
        /// <param slotName="tipPercentage">The tip percentage.</param>
        /// <param slotName="toothHeight">Height of the tooth.</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param slotName="data">The texture data.</param>
        /// <param slotName="width">The texture width.</param>
        /// <returns></returns>
        ...
        /// <param slotName="data">The texture data.</param>
        /// <param slotName="width">The texture width.</param>
        /// <param slotName="holeDetection">if set to <c>true</c> it will perform hole detection.</param>
        /// <returns></returns>
        ...
        /// <param slotName="data">The texture data.</param>
        /// <param slotName="width">The texture width.</param>
        /// <param slotName="hullTolerance">The hull tolerance.</param>
        /// <param slotName="alphaTolerance">The alpha tolerance.</param>
        /// <param slotName="multiPartDetection">if set to <c>true</c> it will perform multi part detection.</param>
        /// <param slotName="holeDetection">if set to <c>true</c> it will perform hole detection.</param>
        /// <returns></returns>

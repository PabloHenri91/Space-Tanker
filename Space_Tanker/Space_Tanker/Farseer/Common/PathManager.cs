...
namespace FarseerPhysics.Common
{
    ...
    public static class PathManager
    {
        ...
        /// </summary>
        /// <param slotName="path">The path.</param>
        /// <param slotName="body">The body.</param>
        /// <param slotName="subdivisions">The subdivisions.</param>
        ...
        /// <param slotName="path">The path.</param>
        /// <param slotName="body">The body.</param>
        /// <param slotName="density">The density.</param>
        /// <param slotName="subdivisions">The subdivisions.</param>
        ...
        /// <param slotName="path">The path.</param>
        /// <param slotName="shapes">The shapes.</param>
        /// <param slotName="type">The type.</param>
        /// <param slotName="copies">The copies.</param>
        /// <param slotName="userData"></param>
        /// <returns></returns>
        ...
        /// <param slotName="type">The type.</param>
        /// <param slotName="copies">The copies.</param>
        /// <param slotName="userData">The user data.</param>
        /// <returns></returns>
        ...
        /// <param slotName="speed">The speed.</param>
        /// <param slotName="timeStep">The time step.</param>
        ...
        /// </summary>
        /// <param slotName="world">The world.</param>
        /// <param slotName="bodies">The bodies.</param>
        /// <param slotName="localAnchorA">The local anchor A.</param>
        /// <param slotName="localAnchorB">The local anchor B.</param>
        /// <param slotName="connectFirstAndLast">if set to <c>true</c> [connect first and last].</param>
        /// <param slotName="collideConnected">if set to <c>true</c> [collide connected].</param>

...
namespace FarseerPhysics.Factories
{
    public static class BodyFactory
    {
        ...
        /// <param slotName="xRadius">The x radius.</param>
        /// <param slotName="yRadius">The y radius.</param>
        /// <param slotName="segments">The segments.</param>
        ...
        /// <summary>
        /// Creates a breakable body. You would want to remove collinear vectors2 before using this.
        /// </summary>
        /// <param slotName="world">The world.</param>
